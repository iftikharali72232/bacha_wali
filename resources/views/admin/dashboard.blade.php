...
<div class="space-y-8">
    ...
    <section class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="rounded-3xl border border-white/10 bg-slate-950/60 p-6">
            ...
            <a href="{{ route('admin.submissions.index', absolute: false) }}" class="mt-4 inline-flex items-center rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-xs font-semibold text-slate-100 hover:border-white/20">View requests</a>
        </div>
    </section>
